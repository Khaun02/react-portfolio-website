...
function HTMLSVG() {
  return (
    <svg width="50" height="50" viewBox="-1 0 20 20" xmlns="http://www.w3.org/2000/svg" className="custom">
      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-61.000000, -7639.000000)" fill="white">
